...
/// together with its outbox event. BMI history can grow very large, so no
...
class BmiLogLocalDataSource extends BaseLocalDataSource {
  ...
  Future<void> insertAll(List<BmiLog> logs) {
  ...
  Future<List<BmiLog>> getByDateRange(
    String userId,
    DateTime start,
    DateTime end,
  ) {
